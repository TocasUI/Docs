...
module.exports = {
	...
	"intro": "<p>Tocas UI 的網格系統和 Bootstrap 的較為不同，比起 Bootstrap 來說，Tocas UI 且更具彈性與更強大的功能還更加地自動化。</p>\n<p>為了方便展示網格系統，我們將背景加上了灰色，在實際應用中將會是透明的。</p>\n",
	"styles": [
		{
			"category": "教學",
		...
		},
		{
			...
			"items": [
				...
				{
					"title": "內容",
					"description": "<p>欄位<strong>不應該被套用任何自訂的樣式</strong>，欄位只是一個容器，你應該在裡面放入你要的元素和樣式，而<strong>不是直接在欄位上更改</strong>。</p>\n",
				...
				{
					"title": "寬度",
					"description": "<p>欄位的寬度由 <span class=\"ts horizontal label\">* wide</span> 決定，例如 <span class=\"ts horizontal label\">one wide</span> 就是一格，<span class=\"ts horizontal label\">sixteen wide</span> 則是十六格。</p>\n<p>十六格剛好會符合一行最大的寬度，八格則是填滿一行的一半。</p>\n",
					"code": "<div class=\"ts grid\">\n    <div class=\"[[one wide]] column\"></div>\n    <div class=\"[[fifteen wide]] column\"></div>\n    <div class=\"[[three wide]] column\"></div>\n    <div class=\"[[thirteen wide]] column\"></div>\n    <div class=\"[[six wide]] column\"></div>\n    <div class=\"[[ten wide]] column\"></div>\n    <div class=\"[[four wide]] column\"></div>\n    <div class=\"[[twelve wide]] column\"></div>\n    <div class=\"[[sixteen wide]] column\"></div>\n</div>\n"
				},
				{
					"title": "拉伸的",
					"description": "<p>不指定欄位寬度的時候，單個、或多個欄位可以被拉伸到填滿整個網格系統，並將其他欄位縮短至它們的內容寬度。這很適合用在兩欄式的排版，或是輸入欄位與按鈕。</p>\n",
		...
		},
		{
			...
			"items": [
				{
					"title": "寬度細分",
					"description": "<p>你可以在「列」裡面規劃這一列應該要有幾個欄位，例如 <span class=\"ts horizontal label\">two column</span> 就能夠指列有<strong>兩個欄位</strong>，也就是一格欄位有<strong>八格寬</strong>。</p>\n<p>因為一列最多允許十六格，為了達成一列中有兩個欄位，即是 <span class=\"horizontal label\">16 / 2 = 8</span>。</p>\n<p>當你了解如何善用寬度細分，你也能夠將一列切成三個欄位，甚至四個、五個，而不會因為欄位寬度無法除盡十六而作罷。</p>\n",
		...
		},
		{
			...
			"items": [
				...
				{
					"title": "寬度細分",
					"description": "<p>這和「列」的寬度細分相同，但你可以<strong>直接在網格上進行細分</strong>，例如 <span class=\"ts horizontal label\">four column</span> 就能夠指定網格系統的一行會有<strong>四個欄位</strong>，也就是一格欄位有<strong>四格寬</strong>。</p>\n<p>因為一列最多允許十六格，為了達成一列中有四個欄位，即是 <span class=\"ts horizontal label\">16 / 4 = 4</span>。</p>\n<p>透過這種方法不需要手動設定每一個欄位要有幾格寬，十分地方便。</p>\n",
					"code": "<div class=\"ts [[four column]] grid\">\n    <div class=\"[[two column]] row\">\n        <div class=\"column\"></div>\n    </div>\n    <div class=\"column\"></div>\n    <div class=\"column\"></div>\n    <div class=\"column\"></div>\n    <div class=\"column\"></div>\n</div>\n"
				},
				{
					"title": "置中",
