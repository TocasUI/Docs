...
module.exports = {
	"slate": {
		"title": "圖片",
		"description": "搭拉，這看起來跟你本人不太像。"
	},
	"intro": "<p>圖片在不指定大小的情況下，預設最大至少可以填滿整個容器。</p>\n",
	"styles": [
		{
			"category": "種類",
			...
			"items": [
				{
					...
					"code": "<img class=\"ts small [[image]]\" src=\"!-4:3-!\">\n"
				},
				{
					"title": "連結",
			...
			"items": [
				{
					"title": "隱藏",
					"description": "隱藏一個圖片。",
					"code": "<img class=\"ts [[hidden]] image\" src=\"!-4:3-!\">\n"
				},
				{
					"title": "已停用",
					"description": "顯示一個圖片已經過時、不可用。",
					"code": "<img class=\"ts [[disabled]] small image\" src=\"!-4:3-!\">\n"
				}
			]
		},
		{
